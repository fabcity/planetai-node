...
RAM and disk are the runtime vendor's floors, not the node's own; the node's measured footprint is a separate
number and is not in this table until it has been measured on amd64.
