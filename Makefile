...
.PHONY: up update bootstrap down restart logs health stats alerts cells rho backup lint test ship released
up:      ; ./install.sh
update:  ; ./update.sh
